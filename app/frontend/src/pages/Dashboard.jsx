  ...
  return (
    <Box>
      ...
      <Box mb={{ base: 4, md: 6, lg: 8 }}>
        ...
        <Text fontSize={{ base: "xs", md: "sm" }} color="gray.600">おかえりなさい！フィットネスの概要です。</Text>
      </Box>
          ...
          <CardBody>
            <VStack align="stretch" spacing={4}>
              {dashboardData?.recent_progress ? (
                <>
                  <Box p={4} bg={progressBlueBg} borderRadius="md">
                  ...
                  <Box p={4} bg={progressGreenBg} borderRadius="md">
                    <HStack justify="space-between" mb={2}>
      ...
      <Card bg={bgColor} borderWidth="1px" borderColor={borderColor} mt={6}>
        ...
        <CardBody>
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
            ...
            <Box>
              <Text fontSize="sm" fontWeight="medium" mb={2}>基礎代謝 (BMR)</Text>
